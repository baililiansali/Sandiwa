...
export const Route = createFileRoute("/learner/community/")({
  head: () => ({
    meta: [
      ...
      <SiteLayout>
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-4 text-center sm:hidden">
            <Link to="/learner/community/events" className="text-sm font-medium text-gold hover:underline">
              View all events →
            </Link>
          </div>
        </section>
        ...
        <section className="bg-cream/30 py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-6 text-center sm:hidden">
              <Link to="/learner/community/discussions" className="text-sm font-medium text-gold hover:underline">
