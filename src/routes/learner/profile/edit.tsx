...
export const Route = createFileRoute("/learner/profile/edit")({
    head: () => ({
        meta: [
            ...
            <SiteLayout>
                <div className="bg-cream min-h-screen py-10">
                    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
                        <Link to="/learner/profile" className="inline-flex items-center gap-2 text-sm text-gold hover:underline mb-6">
