            ...
            <SiteLayout>
                ...
                <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
                    <div className="flex items-center justify-between">
                        ...
                        <Link to="/learner/courses/courses" className="text-sm text-gold hover:underline inline-flex items-center gap-1">
                ...
                <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
                    <div className="flex items-center justify-between">
                        ...
                        <Link to="/learner/mentors/mentors" className="text-sm text-gold hover:underline inline-flex items-center gap-1">
                            View all <ArrowRight className="h-4 w-4" />
                        </Link>
                    </div>
                ...
                <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    {enrolledCourses.length > 4 && (
                        <div className="text-center mt-4">
                            <Link to="/learner/profile" className="text-sm text-gold hover:underline">
