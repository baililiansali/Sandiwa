...
export const Route = createFileRoute("/mentor-learner/community/events/$eventId/edit")({
  head: () => ({
    meta: [
...
function EditEventPage() {
  ...
  useEffect(() => {
    ...
    if (event) {
      ...
      navigate({ to: "/mentor-learner/community/events" });
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        navigate({ to: "/mentor-learner/community/events/$eventId", params: { eventId } });
      }, 500);
    }, 1000);
  };
