...
export const Route = createFileRoute("/mentor-learner/community/events/$eventId")({
  component: EventDetailPage,
  notFoundComponent: () => (
    <MentorDashboardLayout>
      <div className="mx-auto max-w-2xl py-24 text-center">
        <h1 className="font-serif text-3xl font-bold">Event not found</h1>
        <Link to="/mentor-learner/community/events" className="mt-4 inline-block text-gold hover:underline">
          Back to events
        </Link>
      </div>
    </MentorDashboardLayout>
