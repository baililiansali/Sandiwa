...
export const Route = createFileRoute("/mentor-learner/community/events/create")({
  head: () => ({
    meta: [
      { title: "Create Event — Sandiwa" },
...
function CreateEventPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const userId = localStorage.getItem("userId") || sessionStorage.getItem("userId") || "learner_001";
