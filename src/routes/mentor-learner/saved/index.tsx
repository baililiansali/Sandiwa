...
import { Bookmark, Download, Trash2, Play, Clock, X, Star } from "lucide-react";
...
export const Route = createFileRoute("/mentor-learner/saved/")({
  head: () => ({
    meta: [
      { title: "Saved Content — Sandiwa" },
      { name: "description", content: "Your saved lessons and offline content." },
    ],
  }),
  component: SavedPage,
});
          ...
          <div className="mx-auto max-w-5xl px-4">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-muted-foreground mt-1">Lessons you've saved for later or offline access</p>
              </div>
            ...
            {savedItems.length === 0 ? (
              <div className="text-center py-16 rounded-xl border border-border bg-card">
                ...
                <p className="text-sm text-muted-foreground mt-1">Click the star icon on any lesson to save it here</p>
                    ...
                    <div className="flex flex-col sm:flex-row">
                      ...
                      <div className="sm:w-48 h-32 bg-muted relative">
                        ...
                        <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 hover:opacity-100 transition">
                          <Link to="/mentor-learner/learn/$courseId" params={{ courseId: item.courseId }}>
                            ...
                            <div className="flex items-center gap-3 mt-2 text-xs text-muted-foreground">
                              ...
                              {item.timestamp > 0 && (
                                <span className="flex items-center gap-1">
                                  ...
                                  Bookmark at {formatTime(item.timestamp)}
                                </span>
                              )}
                            </div>
                          </div>
