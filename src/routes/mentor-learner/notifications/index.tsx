...
export const Route = createFileRoute("/mentor-learner/notifications/")({
  head: () => ({
    meta: [
          ...
          <div className="mx-auto max-w-4xl px-4 py-8">
            ...
            {notifications.length === 0 ? (
              <div className="text-center py-16 rounded-xl border border-border bg-card">
                ...
                <Link to="/mentor-learner/dashboard" className="text-gold hover:underline text-sm mt-2 inline-block">
                  Return to Dashboard
                </Link>
              </div>
            ) : (
