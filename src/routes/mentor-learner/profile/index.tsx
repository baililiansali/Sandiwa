...
export const Route = createFileRoute("/mentor-learner/profile/")({
    head: () => ({
        meta: [
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-3 flex-wrap">
                                    ...
                                    <Link to="/mentor-learner/profile/edit">
                    ...
                    <div className="mt-12">
                        <div className="flex items-center justify-between flex-wrap gap-4">
                            ...
                            <Button asChild size="sm" variant="outline" className="border-gold text-gold hover:bg-gold hover:text-white">
                                <Link to="/mentor-learner/community/events">Browse More Events</Link>
                            </Button>
                        </div>
                        ...
                        {registeredEvents.length > 0 ? (
                                        ...
                                        <div key={event.id} className="rounded-xl border border-border bg-card p-5 hover:shadow-md transition-all">
                                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                                ...
                                                <div className="flex gap-2">
                                                    <Link to="/mentor-learner/community/events/$eventId" params={{ eventId: event.id }}>
                            ...
                            <div className="mt-5 rounded-xl border border-border bg-card p-12 text-center">
                                ...
                                <Button asChild className="mt-4 bg-gold hover:bg-gold/90 text-white">
                                    <Link to="/mentor-learner/community/events">Explore Events</Link>
                                </Button>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="mt-12">
                        ...
                        {createdEvents.length > 0 ? (
                                        ...
                                        <div key={event.id} className="rounded-xl border border-border bg-card p-5 hover:shadow-md transition-all">
                                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                                ...
                                                <div className="flex gap-2">
                                                    ...
                                                    <Link to="/mentor-learner/community/events/$eventId/edit" params={{ eventId: event.id }}>
                                                        <Button size="sm" variant="outline" className="border-gold text-gold hover:bg-gold hover:text-white">
                            ...
                            <div className="mt-5 rounded-xl border border-border bg-card p-12 text-center">
                                ...
                                <Button asChild className="mt-4 bg-gold hover:bg-gold/90 text-white">
                                    <Link to="/mentor-learner/community/events/create">Create Your First Event</Link>
                                </Button>
                            </div>
                        )}
                    </div>
                                ...
                                <div key={course.id} className="group rounded-xl border border-border overflow-hidden hover:shadow-lg transition-all duration-300 bg-card">
                                    ...
                                    <div className="p-5">
                                        ...
                                        <div className="mt-4 flex items-center justify-between border-t border-border pt-4">
                                            ...
                                            <Link to="/mentor-learner/learn/$courseId" params={{ courseId: course.id }}>
