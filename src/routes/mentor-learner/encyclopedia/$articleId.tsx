...
export const Route = createFileRoute("/mentor-learner/encyclopedia/$articleId")({
  loader: ({ params }) => {
...
function ArticleDetailPage() {
  ...
  const handleGoBack = () => {
    if (document.referrer && document.referrer.includes(window.location.origin)) {
      ...
      navigate({ to: "/mentor-learner/encyclopedia" });
    }
  };
            ...
            {mentor && (
              <div className="flex items-center gap-3 py-4 border-y border-gray-200 mb-8">
                ...
                <div>
                  ...
                  <Link to="/mentor-learner/mentors/mentors/$mentorId" params={{ mentorId: mentor.id }} className="text-gold hover:underline font-medium">
                    {mentor.name}
                  </Link>
