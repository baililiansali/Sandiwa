...
export const Route = createFileRoute("/mentor-learner/payment-success")({
                    ...
                    <div className="text-center">
                        ...
                        <div className="mt-6 flex gap-3 justify-center">
                            <Button asChild className="bg-gold hover:bg-gold/90">
                                <Link to="/mentor-learner/courses/courses">Go to My Courses</Link>
                            </Button>
                            <Button asChild variant="outline">
                                <Link to="/mentor-learner/courses/courses">Browse More Courses</Link>
                            </Button>
                        </div>
                    </div>
                </div>
