...
export const Route = createFileRoute("/mentor-learner/checkout")({
    head: () => ({
        meta: [
            ...
            <MentorDashboardLayout>
                <div className="bg-cream min-h-screen py-10">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <Link to="/mentor-learner/courses/courses" className="inline-flex items-center gap-2 text-sm text-gold hover:underline mb-6">
