...
export const Route = createFileRoute("/mentor-learner/mentors/mentors/$mentorId")({
    loader: ({ params }) => {
    ...
    notFoundComponent: () => (
        <MentorDashboardLayout>
            <div className="mx-auto max-w-2xl py-24 text-center">
                ...
                <Link to="/mentor-learner/mentors/mentors" className="mt-4 inline-block text-gold hover:underline">Back to mentors</Link>
            </div>
        </MentorDashboardLayout>
    ),
...
function MentorDetail() {
    ...
    const handleGoBack = () => {
        ...
        if (document.referrer && document.referrer.includes(window.location.origin)) {
            ...
            navigate({ to: "/mentor-learner/mentors/mentors" });
        }
    };
            ...
            <MentorDashboardLayout>
                ...
                <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <Link to="/mentor-learner/courses/courses" className="text-sm text-gold hover:underline">
                            View all courses →
                        </Link>
                    </div>
