...
import { getArticleById, updateArticle } from "@/stores/encyclopediaStore";

export const Route = createFileRoute("/mentor/encyclopedia/$articleId/edit")({
  loader: ({ params }) => {
...
function EditArticlePage() {
  ...
  if (article.authorId !== user?.id) {
    navigate({ to: "/mentor/encyclopedia/$articleId", params: { articleId: article.id } });
    return null;
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Navigate to the article - FIXED: Use relative path
      navigate({ to: "/mentor/encyclopedia/$articleId", params: { articleId: article.id } });
    } catch (error) {
        ...
        <div className="bg-cream min-h-screen">
          <div className="mx-auto max-w-4xl px-4 py-8">
            <div className="flex justify-between items-center mb-6">
              <button 
                onClick={() => navigate({ to: "/mentor/encyclopedia/$articleId", params: { articleId: article.id } })}
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              <h1 className="font-serif text-3xl font-bold text-navy mb-6">Edit Article</h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-navy mb-2">Featured Image URL *</label>
                  <input
                    type="url"
                    name="image"
                    required
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">Write a detailed description of your article. Plain text only.</p>
                </div>
