...
export const Route = createFileRoute("/mentor/community/events/$eventId/edit")({
  head: () => ({
    meta: [
      { title: "Edit Event — Sandiwa Mentor" },
...
function EditEventPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        navigate({ to: "/mentor/community/events/$eventId", params: { eventId } });
      }, 500);
    }, 1000);
  };
