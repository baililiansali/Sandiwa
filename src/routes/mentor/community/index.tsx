...
export const Route = createFileRoute("/mentor/community/")({
  head: () => ({
    meta: [
      ...
      <MentorDashboardLayout>
        <section className="bg-gradient-to-br from-cream to-white py-20">
          <div className="mx-auto max-w-4xl px-4 text-center">
            ...
            <div className="mt-8">
              <Link
                to="/learner/community/discussions"
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-4 text-center sm:hidden">
            <Link to="/mentor/community/events" className="text-sm font-medium text-gold hover:underline">
              View all events →
            </Link>
          </div>
        </section>
        ...
        <section className="bg-cream/30 py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              ...
              <Link
                to="/mentor/community/discussions"
                className="hidden text-sm font-medium text-gold hover:underline sm:flex items-center gap-1"
              >
            ...
            <div className="mt-6 text-center sm:hidden">
              <Link to="/mentor/community/discussions" className="text-sm font-medium text-gold hover:underline">
