            ...
            <div className="max-w-3xl">
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                    <Button asChild size="lg" className="bg-gold hover:bg-gold/90 text-gold-foreground">
                        <Link to="/learner/courses/courses">
    ...
    return (
        <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="mt-8 text-center">
                <Link to="/learner/courses/courses" className="inline-flex items-center gap-1 text-sm font-medium text-gold hover:underline">
    ...
    return (
        <section className="bg-cream py-16">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-8 text-center">
                    <Link to="/learner/mentors/mentors" className="inline-flex items-center gap-1 text-sm font-medium text-gold hover:underline">
